...
const SYSTEM_PROMPT = `You are the matching engine for InternPulse, a platform helping Pakistani CS/IT students find internships, research positions, hackathons, conferences, and workshops.
